...
def main() -> None:
    ...
    assert re.search(r'data-count-for="math">2 завдання<', chooser), "real Math activity count must render"
    ...
    assert catalog.count('class="activity-link"') == 2, "grade 5 filter must render both production Math links"
